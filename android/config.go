...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Descendant.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.DescendantConfig.JavaSourceOverlayModuleWhitelist
}
